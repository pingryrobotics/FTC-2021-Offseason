...
@TeleOp(name = "Testing: TensorFlow Object Detection", group = "Testing")
public class TensorflowObjectDetection {
    ...
    // vuforia key
    private static final String VUFORIA_KEY = "getkey";

    // make vuforia localizer  and tensorflow object detector object var
